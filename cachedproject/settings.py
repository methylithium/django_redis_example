"""
Django settings for cachedproject project.
...
SECRET_KEY = 'django-insecure-#-4ym^%%qh6ks=bo^e)dpd1mgm@()cv+gxn%hwz!h%#gf(n2j%'
...
ROOT_URLCONF = 'cachedproject.urls'
...
WSGI_APPLICATION = 'cachedproject.wsgi.application'
